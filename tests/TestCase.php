...
namespace Marufsharia\ActivityStreams\Tests;
...
use Marufsharia\ActivityStreams\ActivityStreamsFacade;
use Marufsharia\ActivityStreams\ActivityStreamsServiceProvider;
...
class TestCase extends \Orchestra\Testbench\TestCase
{
    ...
    protected function getEnvironmentSetUp($app)
    {
        ...
        $app['config']->set('activity_streams', include(__DIR__ . '/../config/streams_timeline.php'));
    }
